...
# Sample schedule data - used when initializing the table with data
SCHEDULE_DATA = [
    # Format: subject, day, start_time, end_time, type, section, teacher, room
    ('Advanced Mathematics', 'Monday', '9:00 AM', '11:00 AM', 'lec', 'WC1', 'Dr. Alexander Smith', 'Hall A'),
    ('Advanced Mathematics', 'Wednesday', '2:00 PM', '3:30 PM', 'sec', 'SEC 2', 'Prof. Linda Johnson', 'Room 201'),
    ('Computer Science', 'Tuesday', '10:00 AM', '12:00 PM', 'lec', 'WC1', 'Dr. Rebecca Williams', 'Hall B'),
    ('Computer Science', 'Thursday', '1:00 PM', '3:00 PM', 'lab', 'SEC 2', 'Dr. Rebecca Williams', 'Lab 101'),
    ('Physics', 'Monday', '1:00 PM', '3:00 PM', 'lec', 'WC1', 'Dr. Thomas Brown', 'Hall C'),
    ('Physics', 'Friday', '10:00 AM', '12:00 PM', 'sec', 'SEC 2', 'Prof. Sarah Davis', 'Lab 202'),
    ('Engineering', 'Tuesday', '2:00 PM', '4:00 PM', 'lec', 'WC1', 'Dr. Emily Martin', 'Hall D'),
    ('Engineering', 'Thursday', '9:00 AM', '11:00 AM', 'lab', 'SEC 2', 'Dr. Emily Martin', 'Workshop'),
    ('Statistics', 'Wednesday', '9:00 AM', '11:00 AM', 'lec', 'WC1', 'Prof. Michael Taylor', 'Hall E'),
...
def main():
    ...
    print("\nDone! You can now use the class schedule with the correct structure.")
